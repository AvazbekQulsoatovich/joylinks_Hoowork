...
# Caching Configuration - Using LocMemCache for better speed than DatabaseCache if Redis is not available
CACHES = {
    'default': {
...
# CORS Configuration
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://127.0.0.1:8000,http://localhost:8000').split(',')
