...
from .models import Homework, Submission # type: ignore
...
class HomeworkForm(forms.ModelForm):
    ...
    class Meta:
        model = Homework
        fields = ['group', 'title', 'description', 'file', 'deadline', 'max_score', 'sequence']
        widgets = {
            ...
            'max_score': forms.NumberInput(attrs={'class': 'form-control', 'min': 1, 'placeholder': '100'}),
